...
import static argelbargel.gradle.plugins.build.modules.common.BuildModuleConstants.*
import static argelbargel.gradle.plugins.build.modules.manager.BuildModuleManagerExtension.DEFAULT_MODULES_FILE
import static argelbargel.gradle.plugins.build.modules.manager.BuildModuleManagerPlugin.ACTIVE_MODULES_DIR
import static argelbargel.gradle.plugins.build.modules.manager.BuildModuleManagerPlugin.DEFAULT_MODULES_DIR
